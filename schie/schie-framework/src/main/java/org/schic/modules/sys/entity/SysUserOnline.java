...
import org.schic.common.utils.AddressUtils;
...
/**
 * 
 * @Description: 在线用户记录Entity
 * @author Caiwb
 * @date 2019年5月6日 上午10:48:22
 */
public class SysUserOnline extends AbstractBaseEntity<SysUserOnline> {
	...
	public static final SysUserOnline fromOnlineSession(OnlineSession session) {
		...
		online.setLoginLocation(
				AddressUtils.getRealAddressByIP(session.getHost()));
