...
import org.schic.common.web.Servlets;
...
import org.schic.modules.sys.web.LoginController;

/**
 * 
 * @Description: 系统安全认证实现类
 * @author Caiwb
 * @date 2019年5月6日 上午11:06:10
 */
@Service
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		User user = getSystemService()
				.getUserByLoginName(principal.getLoginName());
		if (user != null) {
			...
			for (Menu menu : list) {
				if (StringUtils.isNotBlank(menu.getPermission())) {
					// 添加基于Permission的权限信息
					for (String permission : StringUtils
