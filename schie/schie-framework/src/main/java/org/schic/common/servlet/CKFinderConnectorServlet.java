...
/**
 * 
 * @Description: CKFinderConnectorServlet
 * @author Caiwb
 * @date 2019年4月29日 下午3:50:13
 */
@WebServlet(urlPatterns = "/static/ckfinder/core/connector/java/connector.java", initParams = {
		...
		@WebInitParam(name = "configuration", value = "org.schic.common.web.CKFinderConfig")}, loadOnStartup = 1)
public class CKFinderConnectorServlet extends ConnectorServlet {
	...
	private void prepareGetResponse(final HttpServletRequest request,
		...
		// 快捷上传，自动创建当前文件夹，并上传到该路径
			...
			String realPath = Global.getUserfilesBaseDir()
					+ Global.USERFILES_BASE_URL + principal + File.separator
