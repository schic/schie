...
public class ImportExcel {
	...
	public ImportExcel(MultipartFile multipartFile, int headerNum,
		...
		this(multipartFile.getOriginalFilename(),
				multipartFile.getInputStream(), headerNum, sheetIndex);
	}
				...
				if (val != null) {
					...
					if (os[1] instanceof Field) {
						...
						if ("get".equals(method.getName().substring(0, 3))) {
							valType = method.getReturnType();
								...
								.equals(method.getName().substring(0, 3))) {
					...
					if (os[1] instanceof Field) {
						...
						if ("get".equals(mthodName.substring(0, 3))) {
							mthodName = "set" + StringUtils
									.substringAfter(mthodName, "get");
						}
