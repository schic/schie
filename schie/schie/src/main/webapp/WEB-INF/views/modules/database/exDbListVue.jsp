            ...
            <table id="contentTable" class="table table-hover table-condensed dataTables-example dataTable">
                <thead>
                    <tr>
                        ...
                        <th  class="sort-column ">数据库url</th>
                        <th  class="sort-column ">数据库用户</th>
                        <%--<th  class="sort-column ">数据库密码</th>--%>
                ...
                <tbody>
                <c:forEach items="${exDbs}" var="exDb">
                    <tr>
                        <td>
...
<script src="/staticViews/modules/db//exDbList.js" type="text/javascript"></script>
<link href="/staticViews/modules/db//exDbList.css" rel="stylesheet" />
</body>
</html>