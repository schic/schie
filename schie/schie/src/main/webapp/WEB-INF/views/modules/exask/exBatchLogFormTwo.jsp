				...
				<div class="content">
					...
					<div class="row">
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">请求的id</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">源头 执行行数</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">源头 执行开始时间</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">源头 执行结束时间</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">源头 是否结束。0为false，1为true</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">源头 执行耗时</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 执行开始时间</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 执行结束时间</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 执行耗时</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 更新行数</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 插入行数</label>
							<div class="col-sm-8">
						...
						<div class="form-group col-xs-6">
							<label class="control-label col-sm-4 pull-left">目标 忽略行数</label>
							<div class="col-sm-8">
