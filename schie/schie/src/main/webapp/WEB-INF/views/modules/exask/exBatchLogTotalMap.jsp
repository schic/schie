...
<div class="col-sm-12"  style="z-index: 1000;background-color: white;">
	<form:form id="searchForm" modelAttribute="exBatchLog" action="${ctx}/ex/exBatchLog/totalMap" method="post" class="form-inline" style="display:none">
...
<c:forEach items="${list}" var="exBatchLog">
        {title:"${exBatchLog.totalDate}<br>统计${exBatchLog.totalCount}次"
        ,content:""
        ,point:(113.271431+${exBatchLog.totalCount})+"|"+(23.135336+${exBatchLog.totalCount}),isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}},
</c:forEach>
	{title:"保存日志成功<br>统计${sumTotalCount}次。"
	,content:""
