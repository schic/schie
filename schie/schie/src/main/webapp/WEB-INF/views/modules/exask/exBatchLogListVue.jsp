...
<div class="wrapper" id="rrapp">
    ...
    <div class="box box-main">
        ...
        <div class="box-header">
            ...
            <div class="box-tools pull-right">
				...
				<shiro:hasPermission name="ex:exBatchLog:export">
                 ...
                 <a href="${ctx}/ex/exBatchLog/list" title="Vue" class="btn btn-default btn-sm"><i
        ...
        <div class="box-body">
			<!--查询条件-->
			<form:form id="searchForm" modelAttribute="exBatchLog" action="${ctx}/../rest/ex/exBatchLog/list" method="post" class="form-inline">
			...
			<table id="contentTable" class="table table-hover table-condensed dataTables-example dataTable">
				...
				<tbody>
					<tr  v-for="item in page" >
						...
						class="i-checks"></td>
						<td  class=""><a  href="#" v-on:click="openDialogView('查看保存日志成功', '${ctx}/ex/exBatchLog/form?id='+item.id,'800px', '500px')">
						{{item.resAskid}}
						</a></td>
						<td  class="">
						{{item.srcRows}}
