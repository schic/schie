...
public class ExNodeRestController extends AbstractBaseController {
	...
	public Result findListRequestParam(ExNode exNode, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	@ApiImplicitParam(name = "exNode", value = "节点", dataType = "ExNode",paramType="query")
	public Result listRequestParam(ExNode exNode, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	private Result list(ExNode exNode, Model model) {
		Page<ExNode> page = exNodeService.findPageCache(new Page<ExNode>(exNode.getPageNo(),exNode.getPageSize(),exNode.getOrderBy()), exNode);
	...
	@ApiImplicitParam(name = "exNode", value = "节点", dataType = "ExNode",paramType="query")
	public Result listFristRequestParam(ExNode exNode, HttpServletRequest request, HttpServletResponse response, Model model) {
