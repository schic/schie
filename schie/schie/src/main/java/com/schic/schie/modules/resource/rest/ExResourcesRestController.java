...
public class ExResourcesRestController extends AbstractBaseController {
	...
	public Result findListRequestParam(ExResources exResources, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	@ApiImplicitParam(name = "exResources", value = "操作成功", dataType = "ExResources",paramType="query")
	public Result listRequestParam(ExResources exResources, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	private Result list(ExResources exResources, Model model) {
		Page<ExResources> page = exResourcesService.findPageCache(new Page<ExResources>(exResources.getPageNo(),exResources.getPageSize(),exResources.getOrderBy()), exResources);
	...
	@ApiImplicitParam(name = "exResources", value = "操作成功", dataType = "ExResources",paramType="query")
	public Result listFristRequestParam(ExResources exResources, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	@ApiImplicitParam(name = "exResources", value = "操作成功", dataType = "ExResources",paramType="body")
	public Result saveRequestBody(@RequestBody ExResources exResources, Model model, RedirectAttributes redirectAttributes) {
		return save(exResources,model,redirectAttributes);
	}
	...
	@ApiImplicitParam(name = "exResources", value = "操作成功", dataType = "ExResources",paramType="body")
	public Result deleteByLogicRequestBody(@RequestBody ExResources exResources, RedirectAttributes redirectAttributes) {
		return deleteByLogic(exResources,redirectAttributes);
	}
