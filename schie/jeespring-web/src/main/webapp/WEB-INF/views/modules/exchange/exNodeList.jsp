            ...
            <table id="contentTable" class="table table-hover table-condensed dataTables-example dataTable">
                <thead>
                    <tr>
                        ...
                        <th  class="sort-column srvUrl hidden-xs">服务接口地址</th>
                        ...
                        <td>
                            <shiro:hasPermission name="nodes:exNode:view">
                             ...
                             <%--<shiro:hasPermission name="nodes:exNode:edit">--%>
                                <%--<a href="${ctx}/nodes/exNode/form?id=${exNode.id}" title="修改"  title="修改"><i class="fa fa-pencil"></i></a>--%>
                            <%--</shiro:hasPermission>--%>
                            <shiro:hasPermission name="nodes:exNode:del">
                                <a href="${ctx}/nodes/exNode/deleteByLogic?id=${exNode.id}" onclick="return confirmx('确认要删除该节点管理吗？', this.href)" title="删除"><i class="fa fa-trash-o"></i></a>
                            </shiro:hasPermission>
                        </td>
                    </tr>
                </c:forEach>
