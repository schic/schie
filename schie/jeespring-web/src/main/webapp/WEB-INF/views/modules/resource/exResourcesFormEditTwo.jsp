            ...
            <div class="form-group">
                ...
                <c:if test="${action eq 'sh'}">
					<a id="btnView1" class="btn btn-danger pull-right " style="margin-right: 80px;" 
							href="${ctx}/exapprove/exResApprove/feedback?result=no&resId=${exResources.id}">驳回</a>
				
					<a id="btnView2" class="btn btn-primary pull-right" style="margin-right: 60px;" 
							href="${ctx}/exapprove/exResApprove/feedback?result=yes&resId=${exResources.id}">通过</a>
				</c:if>
            </div>
        </div>
        </form:form>
