...
public class X12Tests2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            TransactionType collection = (TransactionType) ((JAXBElement<TransactionType>) unmarshaller.unmarshal(X12Tests2.class.getResourceAsStream("xml/997.4010.xml"))).getValue();
