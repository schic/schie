...
@XmlType(name = "SegmentType", propOrder = { "name", "usage", "pos", "syntaxOrMaxUse", "endTag",
        "elementOrComposite" })
public class SegmentType {
    ...
    @XmlElementRefs({ @XmlElementRef(name = "syntax", type = JAXBElement.class),
    ...
    @XmlElements({ @XmlElement(name = "element", type = ElementType.class),
     ...
     * why there is not a <CODE>set</CODE> method for the syntaxOrMaxUse property.
     * 
     * <p>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the elementOrComposite property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
