...
public class EditorConstants {
    ...
    public final static Font DEFAULT_FONT = new Font(UIConstants.MONOSPACED_FONT_NAME, Font.PLAIN, 12);
    public final static Font DEFAULT_FONT_BOLD = new Font(UIConstants.MONOSPACED_FONT_NAME, Font.BOLD, 12);
