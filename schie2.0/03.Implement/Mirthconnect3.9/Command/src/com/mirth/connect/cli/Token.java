...
/**
 * Object representing one token in the command shell language. A token is either a keyword like
 * "channel" or "remove" (statically defined, hardcoded), or a generic string or int (created
 * dynamically when seen in the input).
 */
public class Token {
