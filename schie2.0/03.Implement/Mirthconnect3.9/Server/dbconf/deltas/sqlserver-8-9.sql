...
ALTER TABLE PERSON ADD GRACE_PERIOD_START DATETIME DEFAULT NULL

INSERT INTO CONFIGURATION (CATEGORY, NAME, VALUE) VALUES ('core', 'smtp.timeout', '5000')

INSERT INTO CONFIGURATION (CATEGORY, NAME, VALUE) SELECT 'core', 'encryption.key', DATA FROM ENCRYPTION_KEY
