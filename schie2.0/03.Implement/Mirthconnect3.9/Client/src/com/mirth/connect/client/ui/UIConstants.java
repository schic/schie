...
public class UIConstants {
    ...
    // fonts
    public static final String MONOSPACED_FONT_NAME = SystemUtils.IS_OS_MAC ? "宋体" : "宋体";
    public static final Font TEXTFIELD_PLAIN_FONT = new Font("宋体", Font.PLAIN, 14);
    public static final Font TEXTFIELD_BOLD_FONT = new Font("宋体", Font.BOLD, 14);
    public static final Font BANNER_FONT = new Font("宋体", Font.BOLD, 40);
    public static final Font DIALOG_FONT = new Font("宋体", Font.PLAIN, 14);
    public static final Font MONOSPACED_FONT = new Font(MONOSPACED_FONT_NAME, Font.PLAIN, 14);
