...
<div class="notice">
    ...
    <div id="text007" class="timeline-body" style="white-space:pre-wrap;display: none"><font style="font-weight: bold"></font></div>
    ...
    function onload() {
            $.ajax({
                ...
                success: function(data){
                    ...
                    var source=datalist;
                    //j =  通道个数   当没有通道被部署时   list是空的  datalist.list.length为0
                    if (datalist.list == 0){
                        document.getElementById('text007').style.display = "";
                        document.getElementById('text007').innerHTML = "<font style=\"color: red;font-weight: bold\">当前mc节点没有通道被部署</font>";
                        return null;
                    }
                    ...
                    var newBody="";
                    newBody += "<tr class='logo' id=\"childtemplate\"><td id=\"pname\">"+"通道名称"+"</td>"
                        +"  <td id=\"pStatus\">"+"通道状态"+"</td>"
                        +"<td id=\"pReceived\">"+"消息接收"+"</td>"
                        +"<td id=\"pFiltered\">"+"消息过滤"+"</td>"
                        +"<td id=\"pQueued\">"+"排队中"+"</td>"
                        +"<td id=\"pSent\">"+"消息发送"+"</td>"
                        +"<td id=\"pErrored\">"+"错误"+"</td></tr>"
                    ;
                    ...
                    for (var i = 0; i < j ; i++) {
                        ...
                        //当前通道
                        var tbBody = "";
                        tbBody += "<tr class=\"cdata"+i+"\" id=\"ptemplate"+i+"\"><td id=\"name"+i+"\" onClick=\"td_click(this.id)\">"+"<font style=\"color: blue;font-weight: bold\">"+dashboardStatus.name+"</font>"+"</td>"
                            +"<td id=\"Status\">"+"<font style=\"color: green;\">"+dashboardStatus.state+"</font>"+"</td>"
                            ...
                            +"<td id=\"Errored\" style=\"background-color: red\">"+dashboardStatus.statistics.entry[3].long+"</td>"
                            +"</tr>"
                        ;
                        $("#datas").append(tbBody);
                        var lefttbBody = "";
                        lefttbBody += "<tr class=\"cdata"+i+"\" id=\"ptemplate"+i+"\"><td id=\"name"+i+"\" onClick=\"td_click(this.id)\">"+"<font style=\"color: blue;font-weight: bold\">"+dashboardStatus.name+"</font>"+"</td>"
                            +"<td id=\"Status\">"+"<font style=\"color: green;\">"+dashboardStatus.state+"</td>"
                            ...
                            +"<td id=\"Errored\" style=\"background-color: red\">"+dashboardStatus.lifetimeStatistics.entry[3].long+"</td>"
                            +"</tr>"
                        ;
