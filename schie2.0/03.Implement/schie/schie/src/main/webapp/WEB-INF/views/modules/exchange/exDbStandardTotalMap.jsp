...
<div class="col-sm-12"  style="z-index: 1000;background-color: white;">
	<form:form id="searchForm" modelAttribute="exDbStandard" action="${ctx}/exchange/exDbStandard/totalMap" method="post" class="form-inline" style="display:none">
...
<c:forEach items="${list}" var="exDbStandard">
        {title:"${exDbStandard.totalDate}<br>统计${exDbStandard.totalCount}次"
        ,content:""
        ,point:(113.271431+${exDbStandard.totalCount})+"|"+(23.135336+${exDbStandard.totalCount}),isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}},
</c:forEach>
	{title:"数据表<br>统计${sumTotalCount}次。"
	,content:""
