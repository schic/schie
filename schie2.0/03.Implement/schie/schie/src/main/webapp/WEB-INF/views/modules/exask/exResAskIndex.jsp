        ...
        <div class="wrapper">
            ...
            <div class="box box-main">
                ...
                <div class="box-header">
                    <div class="box-title">
                        <i class="fa fa-edit"></i>可用资源
                    </div>
                    <div id="organ" class="col-sm-12" >
                        <sys:treeselect id="company" name="company.id" onChange="companyChange" value="${user.company.id}"
                                        labelName="company.name" labelValue="请切换机构"
                                        title="机构" url="/sys/office/treeData?type=1&&isAll=true"
...
<script type="text/javascript">
    ...
    function companyChange(value){
        $.getJSON("${ctx}/test/tree/testTree/tabTreeData?comId="+value+"", function (data) {
            tree = $.fn.zTree.init($("#ztree"), setting, data);
            //tree.expandAll(true);
            // 展开第一级节点
            var nodes = tree.getNodesByParam("level", 0);
