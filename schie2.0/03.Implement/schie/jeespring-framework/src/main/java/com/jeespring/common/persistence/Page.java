...
public class Page<T> implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 9160464382672207660L;
    ...
    public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize) {
        init(request, response, defaultPageSize);
    }

    private void init(HttpServletRequest request, HttpServletResponse response, int defaultPageSize) {
    ...
    public Page(int pageNo, int pageSize, long count, List<T> list) {
        init2(pageNo, pageSize, count, list);
    }

    private void init2(int pageNo, int pageSize, long count, List<T> list) {
        this.setCount(count);
...
//		sb.append("</div>");
        ...
        sb.append("<span class=\"pagination-info\">显示第 " + startIndex + " 到第 " + endIndex + " 条记录，总共 " + count
                + " 条记录</span>");
        ...
        sb.append("<li class=\"" + getSelected(pageSize, 1000) + "\"><a href=\"javascript:" + funcName + "(" + pageNo
                + ",1000,'" + funcParam + "');\">1000</a></li>");
        sb.append("<li class=\"" + getSelected(pageSize, 100000000) + "\"><a href=\"javascript:" + funcName + "("
                + pageNo + ",100000000,'" + funcParam + "');\">全部</a></li>");
        sb.append("</ul>");
