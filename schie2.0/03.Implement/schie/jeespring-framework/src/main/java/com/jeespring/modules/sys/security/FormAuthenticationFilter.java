...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
    ...
    protected void issueSuccessRedirect(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (rememberMe) {
            ...
            CookieUtils.setCookie((HttpServletResponse) response, FormAuthenticationFilter.DEFAULT_USERNAME_PARAM, "", 0);
        }
...
//}
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request,
        ...
        String incorClassNameString = IncorrectCredentialsException.class.getName();
        String unClassNameString = UnknownAccountException.class.getName();
        if (incorClassNameString.equals(className) || unClassNameString.equals(className)) {
            message = "用户或密码错误, 请重试.";
