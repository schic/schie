...
public class EChartsLineTag extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        // 工具栏
        option.toolbox().show(true).feature(Tool.mark, Tool.dataView, Tool.saveAsImage, Tool.magicType,
                new MagicType(Magic.line, Magic.bar, Magic.stack, Magic.tiled), Tool.dataZoom, Tool.restore);
