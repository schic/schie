...
<div class="col-sm-12"  style="z-index: 1000;background-color: white;">
	<form:form id="searchForm" modelAttribute="exResources" action="${ctx}/resource/exResources/totalMap" method="post" class="form-inline" style="display:none">
...
<c:forEach items="${list}" var="exResources">
        {title:"${exResources.totalDate}<br>统计${exResources.totalCount}次"
        ,content:""
        ,point:(113.271431+${exResources.totalCount})+"|"+(23.135336+${exResources.totalCount}),isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}},
</c:forEach>
	{title:"操作成功<br>统计${sumTotalCount}次。"
	,content:""
